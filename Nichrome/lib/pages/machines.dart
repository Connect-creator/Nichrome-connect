...
class MachineData {
  static List<Machine> allMachines = [
    ...
    Machine(
      ...
      categories: ['Packaging Machines'],
      industries: ['Grains', 'Oil','Milk','Sugar','Powders', 'Tea'],
    ...
    Machine(
      ...
      categories: ['Packaging Machines'],
      industries: ['Grains', 'Oil','Milk','Sugar'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Grains','Adhesives','Paint Powders','Sugar','Milk','Powders','Tea','Namkeen','Oil','Adhesives','Lube Oil'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Oil', 'Milk','Powders','Lube Oil'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Grains','Tablets','Powders','Tea','Namkeen','Agrochemicals','Fertilizers'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Grains','Oil','Namkeen','Tablets','Capsules','Gel','Powders','Tea','Agrochemicals','Fertilizers'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Grains','Oil','Namkeen','Tablets','Capsules','Gel','Sugar','Milk','Powders', 'Tea','Agrochemicals','Fertilizers','Adhesives','Lube Oil'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Milk', 'Sugar','Powders','Tea','Namkeen','Oil','Agrochemicals','Fertilizers','Adhesives'],
    ...
    Machine(
      ...
      categories: ['Packaging Systems'],
      industries: ['Oil', 'Sugar','Milk','Powders', 'Tea','Namkeen','Agrochemicals','Fertilizers','Adhesives','Lube Oil'],
